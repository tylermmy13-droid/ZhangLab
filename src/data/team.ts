...
export const team: TeamMember[] = [
  ...
  // ════════════════════════════════════════════
  {
    ...
    name: '张力 / ZHANG Li',
    nameZh: '张力',
    role: 'Chief Physician, Distinguished Professor of Shanghai Jiao Tong University, Doctoral Supervisor, Vice President of Xinhua Hospital',
  ...
  // ════════════════════════════════════════════
  {
    ...
    nameZh: '陈齐山',
    role: 'Associate Chief Physician, Associate Researcher, Doctoral Supervisor',
